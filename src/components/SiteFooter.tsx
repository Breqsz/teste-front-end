// Rodapé com colunas de links e barra de copyright/pagamentos
    ...
    <footer className="site-footer">
      <div className="container">
          ...
          <div className="site-footer__about">
            ...
            <div className="site-footer__social" aria-label="Redes sociais">
              ...
              <a href="#" aria-label="LinkedIn" onClick={(e) => e.preventDefault()}>
                <IconLinkedIn className="site-footer__social-icon" />
              </a>
            </div>
        ...
        <div className="footer-bar">
          <p className="footer-bar__copy">© {new Date().getFullYear()} Econverse. Todos os direitos reservados.</p>
          <div className="footer-bar__payments" aria-label="Formas de pagamento">
            <span className="footer-bar__pay">Visa</span>
            <span className="footer-bar__pay">Elo</span>
            <span className="footer-bar__pay">Mastercard</span>
            <span className="footer-bar__pay">Pix</span>
          </div>
        </div>
      </div>
    </footer>
